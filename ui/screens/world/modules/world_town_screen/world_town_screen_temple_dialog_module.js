...
WorldTownScreenTempleDialogModule.prototype.createDIV = function (_parentDiv)
{
    ...
    this.mNoInjuredLabel = $('<div class="is-no-wounded-hint text-font-medium font-bottom-shadow font-color-description display-none">Vous n\'avez pas de blessés dans vos rangs qui peuvent être traités ici.</div>');
    ...
    var explanation = $('<div class="text-font-medium font-bottom-shadow font-color-description is-explanation">Traités les blessures ici pour qu\'elles puissent se guerrir plus vite et qu\'elle ne s\'aggravent pas plus sur la route.</div>');
