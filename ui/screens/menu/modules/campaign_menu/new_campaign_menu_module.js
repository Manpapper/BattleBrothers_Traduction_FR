...
NewCampaignMenuModule.prototype.buildOriginSelectionPanel = function (container)
{
	...
	var title = $('<div class="title title-font-big font-color-title">Origine de la Compagnie</div>');
	row.append(title);
...
NewCampaignMenuModule.prototype.buildDifficultyPanel = function (container)
{
	...
	this.mBudgetDifficultyEasyLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-budget-difficulty-easy">Elevé</label>');
	...
	this.mBudgetDifficultyHardLabel = $('<label class="text-font-normal font-color-subtitle" for="cb-budget-difficulty-hard">Bas</label>');
...
NewCampaignMenuModule.prototype.buildFooter = function (container)
{
    ...
    this.mStartButton = layout.createTextButton("Suivant", function() { self.footerStartAction() }, '', 1);

    layout = $('<div class="l-cancel-button"/>');
    footerButtonBar.append(layout);
    this.mCancelButton = layout.createTextButton("Annuler", function() { self.footerCancelAction() }, '', 1);
}
