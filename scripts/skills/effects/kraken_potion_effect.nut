this.kraken_potion_effect <- this.inherit("scripts/skills/skill", {
	...
	{
		return "Le personnage puise sa force dans une source inépuisable, et possède la santé et la résistance de deux hommes. Vous faites semblant de ne pas remarquer les cadavres éventrés que vous trouvez parfois sur son passage.";
	}
	...
	function getTooltip()
	{
		local ret = [
			...
			},
			{
				...
				text = "[color=" + this.Const.UI.Color.PositiveValue + "]+50[/color] de Points de vie"
			},
			{
				id = 12,
				type = "hint",
