		...
		ret.extend([
			{
				...
				text = "Inflige [color=" + this.Const.UI.Color.DamageValue + "]10[/color] - [color=" + this.Const.UI.Color.DamageValue + "]20[/color] de dégâts additionnels qui ignorent l\'armure pour un maximum de 3 cibles"
			},
			{
				id = 7,
				type = "text",
