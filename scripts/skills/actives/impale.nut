this.impale <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Empaler";
		this.m.Description = "Attaque avec la lance jusqu\'à une distance de 2 tuiles et peut être utilisé derrière la ligne de front, hors d\'atteinte de la plupart des armes de mêlée.";
