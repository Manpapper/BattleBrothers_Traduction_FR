this.release_falcon_skill <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Name = "Relâcher le Faucon";
		this.m.Description = "Relâcher votre faucon pour gagner une vision des 12 tuiles environnantes pendant la durée du tour en cours. Peut être utilisé une fois par combat.";
