	...
	function getTooltip()
	{
		local ret = [
			...
			},
			{
				...
				text = "Les[color=" + this.Const.UI.Color.PositiveValue + "]4[/color] prochaines attaques appliqueront l\'effet Empoisonné attacks will apply the Poisoned pour [color=" + this.Const.UI.Color.NegativeValue + "]10[/color] de dégâts par tour."
			}
		];
