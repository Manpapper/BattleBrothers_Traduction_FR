this.round_swing <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Description = "Coupe tout ce qu\'il y a autour de vous, qu\'ils soient alliés ou ennemis, avec un coup tournoyant insouciant. Pas compliqué à esquivé car il n\'est dirigé à rien en particulier, mais peut être ddévastateur s\'il touche. Faites attention à vos hommes autour à moins que vous souhaitiez diminuer le salaire que vous versez!";
