this.split_nose_injury <- this.inherit("scripts/skills/injury/injury", {
	...
	function create()
	{
		...
		this.m.Description = "Un coup a fendu le nez de ce personnage ce qui rend la respirantion un exercice difficile qui fait avaler de grosses quantités de sang à ce personnage.";
