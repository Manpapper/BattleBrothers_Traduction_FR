this.perk_fast_adaption <- this.inherit("scripts/skills/skill", {
	...
	{
		return "Ce personnage s\'adapte rapidement aux mouvements de son adversaire et gagne un bonus de [color=" + this.Const.UI.Color.PositiveValue + "]+" + this.m.Stacks * 10 + "%[/color] de chance de toucher avec n\'importe quelle attaque.";
	}
