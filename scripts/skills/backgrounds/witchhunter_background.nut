	...
	function getTooltip()
	{
		return [
			...
			},
			{
				...
				text = "[color=" + this.Const.UI.Color.PositiveValue + "]+20[/color] de Détermination lors des tests de moral contre la peur, la panique ou les effets de contrôle mental"
			}
		];
	}
