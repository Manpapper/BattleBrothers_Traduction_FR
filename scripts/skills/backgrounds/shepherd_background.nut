this.shepherd_background <- this.inherit("scripts/skills/backgrounds/character_background", {
	...
	function create()
	{
		...
		this.m.BackgroundDescription = "Les bergers sont habitués au travail physique et sont connus pour tenir à distance les loups grâce à leur fronde.";
		this.m.GoodEnding = "Il était inhabituel qu\'un berger comme %name% se retrouve dans une compagnie de mercenaires, mais il s\'est avéré être un guerrier compétent. Les blessures s\'accumulant, il finit par prendre sa retraite, retournant dans sa prairie, bâton en main, et gardant ses moutons jusqu\'à son paisible dernier souffle.";
		this.m.BadEnding = "On pourrait penser qu\'un berger n\'a pas sa place en compagnie de mercenaires et %name% a ,finalement, accepté se fait. Il a quitté la compagnie %companyname% peu de temps après vous et aux dernières nouvelles, il était retourné garder ses moutons. Alors que la plupart des hommes quittaient l\'entreprise de mauvaise humeur, les blessures de %name% n\'ont pas ébranlé son mode de vie docile consistant à regarder des créatures blanches et duveteuses aussi dangereuses qu\'un mauvais rêve. ";
