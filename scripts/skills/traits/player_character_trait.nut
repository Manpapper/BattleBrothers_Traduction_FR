this.player_character_trait <- this.inherit("scripts/skills/traits/character_trait", {
	...
	function create()
	{
		...
		this.m.Description = "Il s\'agit de votre personnage, en d\'autres termes, de vous-même. S\'il meurt, votre campagne se termine. Vous ne pouvez le renvoyer, et il ne désertera jamais.";
