this.oath_of_wrath_ambition <- this.inherit("scripts/ambitions/oaths/oath_ambition", {
	...
	function create()
	{
		...
		this.m.TooltipText = "Le jeune Anselme a rédigé de nombreux manuels de combat martial, dont les plus populaires prônent l\'utilisation d\'armes à deux mains et l\'absence de tact au combat. Du sang séché macule les pages de ces textes.";
