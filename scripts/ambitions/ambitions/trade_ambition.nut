this.trade_ambition <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.ButtonText = "Il y a beaucoup de couronnes à gagner avec le commerce entre les villes. Gagnons une fortune !";
		...
		this.m.SuccessText = "[img]gfx/ui/events/event_55.png[/img]La pensée vous envahit dès le début, et c\'est une pensée qui échappe à beaucoup de capitaines mercenaires. Une idée si simple que peut-être sa simplicité même la camoufle à l\'égo d\'un leader maniant l\'épée. Si %companyname% doit voyager de ville en ville à la recherche de travail, on peut déjà avoir un pied dans une toute autre vocation : celle du commerce. Vous avez vite compris que les marchandises ont une valeur différente de celle qui apparaît à première vue, une valeur cachée à l\'œil nu, et cachée dans les fluctuations du temps et de l\'espace. Maintenant, vous passez des soirées à vous battre pour compter les couronnes. Pour une fois, c\'est un bon problème à avoir.";
