this.roster_of_12_ambition <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.ButtonText = "Nous allons augmenter l\'effectif de la compagnie à une douzaine d\'hommes !\nCela fera de nous une force formidable et nous permettra d\'entreprendre des travaux plus rentables.";
