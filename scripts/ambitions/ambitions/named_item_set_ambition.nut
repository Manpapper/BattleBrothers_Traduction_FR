this.named_item_set_ambition <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.ButtonText = "Une compagnie renommée se reconnaît à son équipement. Nous devrions nous\nrendre sur place et réclamer une arme, un bouclier, une armure et un casque prestigieux pour accroître notre renommée.";
