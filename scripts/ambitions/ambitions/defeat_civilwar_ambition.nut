this.defeat_civilwar_ambition <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.ButtonText = "Si nous pouvons gagner cette guerre pour l\'une des maisons nobles, notre nom sera inégalé.\n Choisissons un camp, baignons-nous dans la gloire de la bataille et devenons riches !";
		this.m.UIText = "Mettre fin à la guerre entre les maisons nobles";
