this.discover_unique_locations_ambition <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.ButtonText = "Les régions sauvages regorgent de trésors cachés que d\'autres n\'ont pas l\'audace de revendiquer. C\'est notre chance, alors partons à la recherche de trois lieux légendaires !";
