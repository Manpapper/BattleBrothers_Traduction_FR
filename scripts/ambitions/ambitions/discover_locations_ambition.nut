this.discover_locations_ambition <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.ButtonText = "Les grands explorateurs deviennent des hommes de légende. S'aventurer dans les \nterres sauvages est une activité périlleuse, mais les histoires que nous raconterons \npar la suite ne feront qu'accroître notre renommée.";
