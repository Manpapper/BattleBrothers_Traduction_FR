this.armor_ambition <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.ButtonText = "Nous équiperons un contingent d\'au moins trois hommes avec des armures lourdes pour servir de rempart contre les adversaires dangereux.";
