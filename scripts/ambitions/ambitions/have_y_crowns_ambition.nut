this.have_y_crowns_ambition <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.ButtonText = "Si une ou deux batailles tournent mal, nous risquons de nous retrouver à court d\'argent et d\'équipement. La compagnie va donc constituer une réserve de 10.000 Couronnes.";
