this.have_z_crowns_ambition <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.ButtonText = "Les couronnes sont synonymes de pouvoir et d\'influence, et on n\'en a jamais assez. Rassemblons 50 000 couronnes et gagnons notre place parmi les nobles et les rois !";
