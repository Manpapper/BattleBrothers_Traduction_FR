this.roster_of_20_ambition <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.ButtonText = "Renforçons nos effectifs jusqu\'à vingt hommes valides pour que les blessés puissent se reposer et que les fatigués reprennent des forces entre les escarmouches.";
