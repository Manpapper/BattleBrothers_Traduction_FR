this.roster_of_16_ambition <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.ButtonText = "Nous allons augmenter l\'effectif de la compagnie à seize hommes !\nCela fera de nous une force formidable et nous permettra d\'entreprendre des tâches plus rentables.";
