this.hire_follower_ambition <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.ButtonText = "Il y a des cuisiniers, des éclaireurs et bien d\'autres qui peuvent nous aider\nen dehors du champ de bataille. Nous engagerons celui qui convient le mieux à nos besoins !";
