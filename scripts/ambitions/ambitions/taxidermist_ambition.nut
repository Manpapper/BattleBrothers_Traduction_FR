this.taxidermist_ambition <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.ButtonText = "Rien n\'inspire plus le respect qu\'un trophée d\'une bête géante des étendues gelées. Allons chasser et donner du travail au taxidermiste !";
