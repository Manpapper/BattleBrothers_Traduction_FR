this.defeat_kraken_ambition <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.ButtonText = "Il y a des rumeurs sur une bête colossale qui se cache dans les marais. Si nous la trouvons et la tuons, la gloire éternelle sera notre récompense !";
