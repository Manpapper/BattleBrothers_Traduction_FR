this.kraken_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	...
	function create()
	{
		...
		this.m.Name = "Bog King\'s Draught";
		this.m.Description = "Take on the aspect of the beast of beasts! With this miracle draught, a cripple becomes as a strongman, and a strongman becomes as a god! Known side effects include an increased appetite and some minor hallucinations.";
		this.m.IconLarge = "";
