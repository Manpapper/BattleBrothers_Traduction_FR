this.strange_meat_item <- this.inherit("scripts/items/supplies/food_item", {
	...
	function create()
	{
		...
		this.m.Name = "Viande étrange";
		this.m.Description = "Des provisions. Viande d\'origine indéfinissable. Manger cela peut sembler risqué, mais il est préférable de ne pas mourir de faim.";
