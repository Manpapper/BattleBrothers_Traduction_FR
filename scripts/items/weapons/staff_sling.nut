this.staff_sling <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Fronde";
		this.m.Description = "Une fronde en cuir sur un bâton, utilisée pour lancer des pierres sur l\'ennemi. Avec des pierres abondantes partout, il ne manquera jamais de munitions.";
