this.tutorial_contract <- this.inherit("scripts/contracts/contract", {
	...
	function createScreens()
	{
		this.m.Screens.push({
			...
			Text = "[img]gfx/ui/events/event_21.png[/img]Tout est parti en vrille. Deux jours plus tôt la compagnie a été engagé pour traquer %boss% et sa bande de voleur, mais c\'est eux qui nous ont trouvés en premier. Une embuscade. Des blagues sur les chevaux, coupés court par une flèche dans la gorge. Des flèches venant de partout et nulle part en même temps. Des hommes hurlant, un doux son face à la mort.\n\nEn voyant la pluie de flèches s\'arrêter, vous sortez votre arme et vos compagnons font de même, enfin pour ceux qui sont vivant... Vous tombez à genoux. Une flèche a percé votre flanc. Vous hurlez de douleur. Un regard rapide où vous voyez vos hommes charger sans vous dans un dernier effort, l\'acier se heurt à l\'acier.\n\nVos yeux et ceux du capitaine se rencontrent, un dernier acquiescement de la tête avant que sa gorge ne soit tranché. Vous êtes laissé aux commandes des derniers hommes encore en vie. Tremblant de douleur, vous vous appuyez sur votre épée et avec toute la détermination que vous pouvez rassembler vous vous relevez encore...",
			Image = "",
			List = [],
			Options = [
				{
