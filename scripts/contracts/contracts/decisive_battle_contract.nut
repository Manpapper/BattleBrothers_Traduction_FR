this.decisive_battle_contract <- this.inherit("scripts/contracts/contract", {
    ...
    },
    {
      ...
      function getResult()
      {
		...
		this.m.Screens.push({
			ID = "BattleWon",
			Text = "[img]gfx/ui/events/event_87.png[/img]{Vous avez triomphé ! Eh bien, vous et les hommes de %commander% également. La bataille a été remportée, c'est ce qui importe le plus. Vous marchez sur les monticules de cadavres pour vous préparer à retourner vers votre employeur. | Des cadavres empilés sur cinq rangs. Des vautours arrachent des morceaux des monticules. Des blessés implorent de l'aide. Certainement, aux yeux d'un étranger, il ne semble pas y avoir de vainqueur ici. %commander%, cependant, s'approche avec un large sourire.%SPEECH_ON%{Bien joué, mercenaire ! Vous devriez retourner vers votre employeur et lui dire ce qui s'est passé ici. | Eh bien, si ce n'est pas le mercenaire. Je n'étais pas sûr que vous y arriveriez. Vous devriez retourner vers votre employeur et lui dire ce qui s'est passé ici.}%SPEECH_OFF% | Un homme blessé implore à vos pieds. Vous ne pouvez pas dire s'il est l'un des hommes de %commander% ou un ennemi. Soudain, une pointe de lance jaillit et transperce l'homme à travers la tête, le laissant perpétuellement de côté. Vous regardez le tueur en train de frotter ses mains au sommet de la lance avec un air accompli." Il pointe du doigt.%SPEECH_ON%Tu es bien le mercenaire, non ? %commander% m'a dit de te dire que tu devrais retourner chez ton employeur. Ça te semble correct ?%SPEECH_OFF%Vous hochez la tête. Un grognement s'élève des monticules de cadavres. L'homme reprend sa lance, la reprenant dans son autre main.%SPEECH_ON%Allez, au travail !%SPEECH_OFF% | La bataille terminée, vous trouvez %commander% rugissant et arrachant son armure et son maillot de corps. Il montre ses blessures, les fléchissant pour qu'elles s'ouvrent comme des écorces de fruit fraîchement coupé. Il demande à ses hommes d'en faire de même, les retournant chacun pour qu'il puisse voir leur dos%SPEECH_ON%Tu vois, les bons guerriers comme nous portent nos blessures ici, ici et ici...%SPEECH_OFF%
Il montre chaque endroit sur le devant de son corps, puis il montre son dos.
%SPEECH_ON%Mais ici, aucun homme ne porte de blessure ici. Parce que nous mourons en avançant, pas un pas en arrière ! N'est-ce pas vrai ?%SPEECH_OFF%
Les hommes applaudissent, bien que certains soient chancelants sur leurs pieds, le sang coulant de leurs blessures. Vous ignorez le théâtre et rassemblez les hommes de la %companyname%. Votre employeur sera certainement heureux d'apprendre les résultats ici, et c'est tout ce qui vous importe vraiment. | %commander% vous salue après la bataille. Il est trempé de sang comme s'il avait coupé la tête de quelqu'un et s'était baigné sous le tronc qui crachait. Une lueur blanche des dents apparaît quand il sourit.
%SPEECH_ON%Voilà ce que j'appelle un combat.%SPEECH_OFF%
Vous demandez s'il dirait la même chose s'il avait perdu. Il rit.
%SPEECH_ON%Oh, le cynique, n'est-ce pas ? Non, je n'avais aucune intention de perdre ici et, si c'était le cas, je n'avais aucune intention d'être en vie pour assister à ma propre défaite.%SPEECH_OFF%
Vous hochez la tête et répondez.
%SPEECH_ON%Rare est l'homme qui a la chance de survivre pour voir sa plus grande défaite. C'était bien de combattre avec vous, commandant, mais je dois retourner chez votre employeur maintenant.%SPEECH_OFF%
Le commandant hoche la tête et se retourne, criant à quelqu'un d'aller lui chercher une serviette. | Vous trouvez %commander% accroupi sur un soldat ennemi blessé. Il passe un poignard le long de la poitrine du pauvre homme, de va-et-vient, le raclant le long de l'armure. Le commandant vous regarde.
%SPEECH_ON%Qu'en penses-tu, mercenaire ? Devrais-je le laisser vivre ?%SPEECH_OFF%
Le prisonnier vous fixe, il penche la tête en avant, clignant des yeux. Vous supposez que c'est un 'oui'. Vous haussez les épaules.
%SPEECH_ON%Cela ne dépend pas de moi. Regarde, c'était bien de combattre avec toi, mais je dois retourner chez ton employeur maintenant.%SPEECH_OFF%
%commander% hoche la tête.
%SPEECH_ON%Au revoir, alors.%SPEECH_OFF%
En partant, le commandant est toujours là, penché à côté de son prisonnier, la lame cliquetant au fur et à mesure de ses allers-retours, de va-et-vient, de va-et-vient. | Vous trouvez %commander% en train de planter un poignard dans le côté de la poitrine d'un homme blessé. L'ennemi abattu cède à la douleur, mais il s'efface rapidement, devenant mou en quelques instants. Un flot de sang suit la récupération de la lame alors que le commandant l'essuie sur son pantalon.
%SPEECH_ON%Droit au cœur, rapide et facile. Quel homme pourrait espérer mieux ?%SPEECH_OFF%
Vous hochez la tête et dites au commandant que vous retournez chez votre employeur pour votre salaire. | Vous regardez %commander% et un groupe de soldats vadrouiller sur le champ de bataille, tuant tout ennemi blessé qu'ils découvrent. %randombrother% demande si nous devrions rapporter au commandant. Vous secouez la tête.
%SPEECH_ON%Non. Nous rapportons à votre employeur. À l'enfer avec cet endroit, allons être payés.%SPEECH_OFF% | Le champ de bataille est jonché de morts et de ceux qui souhaiteraient l'être. Les hommes de %commander% s'affairent à rassembler leurs blessés et à tuer tout ennemi qu'ils trouvent. Le commandant lui-même vous tapote l'épaule, une éclaboussure de sang éclaboussant votre joue.
%SPEECH_ON%Bon travail, mercenaire. Je n'étais pas sûr que vos hommes tiendraient leur part du marché, mais vous l'avez bien fait. Votre employeur devrait être très heureux de vous voir, je crois.%SPEECH_OFF% | Vous allez rassembler les hommes de la %companyname%. %commander% vient à vous, essuyant un chiffon sur une épée, le sang s'en allant en grosses gouttes.
%SPEECH_ON%Partir si tôt ?%SPEECH_OFF%
Vous hochez la tête.
%SPEECH_ON%C'est votre employeur qui nous paie, alors c'est vers lui que nous allons.%SPEECH_OFF%
Le commandant remet son arme dans son fourreau et hoche la tête.
%SPEECH_ON%Ça a du sens. Bon combat, mercenaire. Dommage que je ne puisse pas vous avoir dans mon unité. Vous les gars, vous devez continuer à courir après cette pièce, hein ?%SPEECH_OFF%}",
