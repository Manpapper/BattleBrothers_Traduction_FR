this.early_access_scenario <- this.inherit("scripts/scenarios/world/starting_scenario", {
	...
	function create()
	{
		...
		this.m.Description = "[p=c][img]gfx/ui/events/event_80.png[/img][/p][p]Après des années passées à verser le sang pour une maigre solde, vous avez enfin réuni assez de couronnes pour fonder votre propre compagnie de mercenaires. Trois mercenaires avec lesquels vous avez combattu côte à côte dans le Mur de Boucliers vous ont rejoint.\n\n[color=#bcad8c]Un début rapide dans le monde, sans avantages ou désavantages particuliers.[/color][/p]";
		this.m.Difficulty = 1;
		this.m.Order = 10;
	}
