this.rangers_scenario <- this.inherit("scripts/scenarios/world/starting_scenario", {
	...
	function onSpawnPlayer()
	{
		...
		f.addPlayerRelation(-20.0, "A entendu des rumeurs selon lesquelles vous auriez braconné dans leurs bois.");
