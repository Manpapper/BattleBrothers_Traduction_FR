this.tutorial_scenario <- this.inherit("scripts/scenarios/world/starting_scenario", {
	...
	function create()
	{
		...
		this.m.Description = "[p=c][img]gfx/ui/events/event_21.png[/img][/p][p]Depuis des mois, votre compagnie de mercenaires poursuivait le brigand Hoggart. Mais un revers inattendu l’a réduite à néant. À vous, désormais, de la relever et de lui rendre sa gloire passée.\n\n[color=#bcad8c]Idéal pour les nouveaux joueurs grâce aux conseils et indications fournis au début de l’aventure.[/color][/p]";
		this.m.Difficulty = 1;
		this.m.Order = 0;
	}
