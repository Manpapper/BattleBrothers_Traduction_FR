this.deserters_scenario <- this.inherit("scripts/scenarios/world/starting_scenario", {
	...
	function create()
	{
		...
		this.m.Description = "[p=c][img]gfx/ui/events/event_88.png[/img][/p][p]Pendant trop longtemps vous avez été traîné d\'une bataille sanglante à une autre au bon vouloir de seigneurs cachés dans leurs hautes tours. La nuit dernière, vous vous êtes enfuis de votre camp avec 3 compères. Vous êtes toujours habillés comme des soldats, mais vous êtes des déserteurs, et la corde sera votre fin si vous restez ici trop longtemps.\n\n[color=#bcad8c]Déserteurs :[/color] Commencez avec 3 déserteurs et des armures décentes, mais peu de fonds et une Maison de Nobles qui vous traque.\n[color=#bcad8c]Premiers à courir :[/color] Vos hommes sont toujours les premiers à agir au premier tour d\'un combat.[/p]";
		this.m.Difficulty = 2;
		this.m.Order = 50;
	}
