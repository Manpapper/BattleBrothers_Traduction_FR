...
gt.Const.Strings.PerkName <- {
	...
	SpecDagger = "Maîtrise de la Dagues",
	SpecSword = "Maîtrise de l\'Epée",
	SpecSpear = "Maîtrise de la Lances",
...
gt.Const.Strings.PerkDescription <- {
	...
	Student = "Tout peut être appris si vous y mettez de la volonté. Gagnez un bonus additionnel de [color=" + this.Const.UI.Color.PositiveValue + "]20%[/color] à l\'experience gagné dans les batailles. Au onzième niveau de votre personnage, celui-ci gagnera un point d\'attour supplémentaire et cet atout sera désactivé.\n\nEn jouant avec l\'origine \'Traqueur\', vous recevrez vous point d\'atout au septième niveau.",
	Gifted = "La vie de mercenaire devient facile quand vous êtes naturellement talentueux. Vous gagnez instantanément un niveau pour augmenter les attributs de ce personnage (avec les meilleurs jets de stat possible), cependant vous ne gagnerez pas de point d\'atout.",
	...
	Underdog = "J\'y suis habitué. Le malus de défense en étant entouré d\'ennemis ne s\'applique plus à ce personnage. Si l\'ennemi à l\'atout Poignardeur l\'effet de cet atout est annulé, et le malus de défense en étant entouré est appliqué normalement.",
