...
gt.Const.Strings.PerkDescription <- {
	...
	CripplingStrikes = "Handicaper vos ennemis! La probabilité minimum pour infliger des blessures est augmenté de [color=" + this.Const.UI.Color.PositiveValue + "]33%[/color] pour les armes de mêlée et les armes à distance.",
