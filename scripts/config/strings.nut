...
gt.Const.Strings.PerkDescription <- {
	...
	Fearsome = "Faites-les se disperser et s\'enfuir! Toutes les attaques qui infligent au moins 1 de dégâts déclenchent un jet de moral pour l\'ennemi avec une pénalité égale à [color=" + this.Const.UI.Color.NegativeValue + "]20%[/color] de votre détermination - 10, par contre, si les dégâts sont de 15 ou plus, il n\'y a pas de pénalités.",
	...
	BattleForged = "Vous êtes spécialisé en armure lourde ! Les dégats d\'armure sont réduits par un pourcentage égal à [color=" + this.Const.UI.Color.PositiveValue + "]5%[/color] du total de la valeur de l\'armure (tête et corps). Le plus lourd l\'armure et le casque, le meilleur le bénéfice.\n\nN\'affecte pas les attaques mentales et les Effets de Status, mais peut aider à les esquiver.",
	...
	BagsAndBelts = "Débloque deux emplacements de sacs supplémentaires pour vous aider à transporter vos objets favoris. Les objets placés dans les sacs ne donnent plus de pénalités au Maximum de Fatigue, sauf pour les armes à deux mains.",
	Student = "Tout peut être appris si vous y mettez de la volonté. Gagnez un bonus additionnel de [color=" + this.Const.UI.Color.PositiveValue + "]20%[/color] à l\'experience gagné dans les batailles. Au onzième niveau de votre personnage, celui-ci gagnera un point de talent supplémentaire et ce Talent sera désactivé.\n\nEn jouant avec l\'origine \'Traqueur\', vous recevrez votre point de Talent au septième niveau.",
	...
	SpecThrowing = "Maîtrisez le lancé d\'armes de jet pour blesser ou tuer les ennemies avant même qu\'ils aient le temps de se rapprocher. Les compétences produisent [color=" + this.Const.UI.Color.NegativeValue + "]25%[/color] de Fatigue en moins.\n\nLes dégâts sont augmentés de [color=" + this.Const.UI.Color.PositiveValue + "]30%[/color] en attaquant à 2 tuiles de distance.\n\nLes dégâts sont augmentés de [color=" + this.Const.UI.Color.PositiveValue + "]20%[/color] en attaquant à 3 tuiles de distance.",
